    ...
    public partial class mysearch : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                CONN.Open();
                int counter = 0;
                string mm = $"there are  {counter}  results";
                Label4.Text = mm;
                ...
                if (read.Read())
                {
                  ...
                  $"         <div class=\"row\">\r\n          " +
                  $"          <div class=\"col-sm-9\">\r\n         " +
                  $"               <h4 class=\"search-result-item-heading\"><a href=\"http://localhost:56508/singleProduct.aspx?product_id={read[0]}\">{read[1]}</a></h4>\r\n       " +
                  $"                 <p class=\"info\"></p>\r\n             " +
