...
namespace WebApplication3
{
    public partial class Editproduct : System.Web.UI.Page
    {
        ...
        protected void addedit_Click(object sender, EventArgs e)
        {
            ...
            connection.Close();
            connection.Open();
            string guery = $"update product set product_name=@product_name,prodct_price=@prodct_price,quantity=@quantity,detalis=@detalis,sale=@sale,author=@author,category_id=@category_id,product_picture=@product_PICTURE where product_id={@id};";
