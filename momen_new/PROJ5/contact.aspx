...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-envelope-o"></i></div>
    <div class="w3-rest">
      <asp:TextBox class="w3-input w3-border" name="email" type="text" placeholder="Email" id="email" runat="server"  required="true"></asp:TextBox>
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-phone"></i></div>
    <div class="w3-rest">
      <asp:TextBox class="w3-input w3-border" name="phone" type="number" placeholder="Phone" id="phone" runat="server" ></asp:TextBox>
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-pencil"></i></div>
    <div class="w3-rest">
      <asp:TextBox class="w3-input w3-border" name="message" type="text" placeholder="Message" id="msg" required="true" runat="server" style="height: 250px;"></asp:TextBox>
    </div>
</div>
