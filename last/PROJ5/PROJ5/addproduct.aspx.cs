...
namespace WebApplication3
{
    public partial class addproduct : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            SqlConnection connection = new SqlConnection("data source=DESKTOP-B9B8CS7;database=LIBRARYBOOKS;Integrated security=SSPI");
            connection.Open();
            SqlCommand command = new SqlCommand($"insert into product values(@product_name,@product_PICTURE,@category_id,@prodct_price,@quantity,@detalis,@sale,@author) where", connection);
