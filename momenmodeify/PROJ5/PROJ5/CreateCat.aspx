<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateCat.aspx.cs" Inherits="PROJ5.CreateCat" %>
...
<body>
  ...
  <label class="input-group-text" for="inputGroupFile01" style="width:143px;">Upload Image</label>
           <asp:FileUpload ID="FileUpload1" class="form-control" runat="server" accept=".png,.jpg,.jpeg,.gif" />
